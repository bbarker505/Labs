...
- (e.g., can quickly zoom/pan maps in ArcMap)  
...
```{r, echo = FALSE, out.width = "1000px", fig.align="center-aligned", fig.cap="Source: Paula Moraga"}
...
```{r, echo = FALSE, out.width = "650px", fig.cap="center-aligned"}
...
knitr::include_graphics(here("Intro_R_mapping", "EAB_map.png"))
```
...
knitr::include_graphics(here("Intro_R_mapping", "emerald-ash-borer-on-leaf.png"))
```
:::
