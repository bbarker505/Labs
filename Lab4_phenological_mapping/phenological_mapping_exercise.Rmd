...
knitr::include_graphics(here("images", "raster_concept.png"))
```
...
knitr::include_graphics(here("images", "sf_map.png"))
```
...
# Save the plot
ggsave(conus_map, filename = here("maps", "Lilac_leaf_out_2018.png"), 
