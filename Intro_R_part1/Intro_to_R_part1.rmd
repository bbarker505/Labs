...
```{r, echo = FALSE}
knitr::include_graphics(here("Intro_R_part1", "images", "top_languages_2019.jpeg"))
```
...
```{r, echo = FALSE, fig.align = "left"}
knitr::include_graphics(here("Intro_R_part1", "images", "JH_Launcher1.png"))
```
...
```{r, echo = FALSE, fig.align = "left"}
knitr::include_graphics(here("Intro_R_part1", "images", "JH_Launcher2.png"))
```

## In Jupyter Hub

- Click on the new folder icon  
- Create a directory (folder) named `Labs`  

```{r, echo = FALSE, fig.align = "left"}
knitr::include_graphics(here("Intro_R_part1", "images", "JH_Launcher3.png"))
```
...
```{r, echo = FALSE, fig.align = "left"}
knitr::include_graphics(here("Intro_R_part1", "images", "JH_Launcher4.png"))
```
...
2. Choose `Existing Directory`, then `New Project`  
...
3. Select the `Labs` folder that you recently created  
...
3. Type `cp -ur $HOME/hub_data_share/Intro_to_R_part1* $HOME/Labs/`

```{r, echo = FALSE, out.width= "800px", fig.align="right"}
knitr::include_graphics(here("Intro_R_part1", "images", "copy_labs_5.png"))
```
